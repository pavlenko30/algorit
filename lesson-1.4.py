...
type_range, raw_start, raw_end, raw_jump = [x for x in input('Введите диапазон: type_range start end jump: ').split()]
...
if type_range == 'int':
    ...
    print(list_int)
    print(f'Случайное целое число из диапазона {start} - {stop}: {random(list_int)}')
    ...
    print(list_float)
    print(f'Случайное вещественное число из диапазона {start} - {stop}: {random(list_float)}')
    ...
    print(list_abc)
    print(f'Случайный символ из из диапазона {start} - {stop}: {random(list_abc)}')
